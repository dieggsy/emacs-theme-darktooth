...
(defmacro darktooth-deftheme (name description palette &rest body)
  ...
  `(autothemer-deftheme ,name ,description ,palette
     ((Man-overstrike                            (:foreground darktooth-sienna))
      ...
      (mode-line                                 (:foreground darktooth-foreground-1 :background darktooth-background-0-hard))
      (mode-line-inactive                        (:foreground darktooth-foreground-4 :background darktooth-background-2))
