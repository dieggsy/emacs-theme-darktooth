...
(defmacro darktooth-deftheme (name description palette &rest body)
  ...
  `(autothemer-deftheme ,name ,description ,palette
     ((Man-overstrike                            (:foreground darktooth-sienna))
      ...
      (ansi-color-black                          (:foreground darktooth-background-0 :background darktooth-background-0))
      (ansi-color-bright-black                   (:foreground "#686868" :background "#686868"))
      (ansi-color-red                            (:foreground darktooth-faded-red :background darktooth-faded-red))
      (ansi-color-bright-red                     (:foreground darktooth-bright-red :background darktooth-bright-red))
      (ansi-color-green                          (:foreground darktooth-faded-green :background darktooth-faded-green))
      (ansi-color-bright-green                   (:foreground darktooth-bright-green :background darktooth-bright-green))
      (ansi-color-yellow                         (:foreground darktooth-faded-yellow :background darktooth-faded-yellow))
      (ansi-color-bright-yellow                  (:foreground darktooth-bright-yellow :background darktooth-bright-yellow))
      (ansi-color-blue                           (:foreground darktooth-faded-blue :background darktooth-faded-blue))
      (ansi-color-bright-blue                    (:foreground darktooth-bright-blue :background darktooth-bright-blue))
      (ansi-color-magenta                        (:foreground darktooth-faded-purple :background darktooth-faded-purple))
      (ansi-color-bright-magenta                 (:foreground darktooth-bright-purple :background darktooth-bright-purple))
      (ansi-color-white                          (:foreground darktooth-foreground-3 :background darktooth-foreground-3))
      (ansi-color-bright-white                   (:foreground darktooth-foreground-0 :background darktooth-foreground-0))
      (ansi-color-cyan                           (:foreground darktooth-faded-cyan :background darktooth-faded-cyan))
      (ansi-color-bright-cyan                    (:foreground darktooth-bright-cyan :background darktooth-bright-cyan))
      ...
      (diff-hl-change                            (:foreground darktooth-bright-purple))
      (diff-hl-delete                            (:foreground darktooth-bright-red))
      (diff-hl-insert                            (:foreground darktooth-bright-green))
      ...
      (diredfl-no-priv                           (:foreground darktooth-background-4))
      (diredfl-number                            (:inherit 'font-lock-constant-face))
      (diredfl-other-priv                        (:background darktooth-background-2))
      (diredfl-rare-priv                         (:background darktooth-background-4))
      ...
      (diredp-compressed-file-suffix             (:inherit 'diredfl-compressed-file-name))
      ...
      (eshell-ls-archive                         (:inherit 'diredfl-compressed-file-name))
      (eshell-ls-directory                       (:inherit 'dired-directory))
      (eshell-ls-executable                      (:inherit 'diredfl-exec-priv))
      ...
      (git-commit-comment-action                 (:inherit 'git-commit-comment-branch-local))
      ...
      (header-line                               (:inherit 'mode-line :overline nil :underline (:color darktooth-background-3 :style 'line :position t)))
      ...
      (ivy-current-match                         (:background darktooth-darker-purple))
      ...
      (ivy-virtual                               (:foreground darktooth-medium))
      ...
      (markdown-header-face-1                    (:foreground darktooth-foreground-4))
      (markdown-header-face-2                    (:foreground darktooth-foreground-3))
      (markdown-header-face-3                    (:foreground darktooth-foreground-2))
      (markdown-header-face-4                    (:foreground darktooth-foreground-1))
      (markdown-header-face-5                    (:foreground darktooth-foreground-0-soft))
      (markdown-header-face-6                    (:foreground darktooth-foreground-0))
      ...
      (mode-line                                 (:foreground darktooth-foreground-1 :background darktooth-background-0 :overline darktooth-background-3))
      (mode-line-inactive                        (:foreground darktooth-background-3  :background darktooth-background-0 :overline darktooth-background-3))
      ...
      (tab-bar                                   (:foreground darktooth-foreground-0 :background darktooth-background-0-hard))
      (tab-bar-tab                               (:foreground darktooth-foreground-0 :background darktooth-background-0 ))
      (tab-bar-tab-inactive                      (:foreground darktooth-foreground-4 :background darktooth-background-0-hard))
      (tab-line                                  (:foreground darktooth-foreground-0 :background darktooth-background-0))
      (term                                      (:inherit 'default))
      (term-color-black                          (:foreground darktooth-background-0 :background darktooth-background-0))
      ...
      (term-color-white                          (:foreground darktooth-foreground-3 :background darktooth-foreground-3))
      ...
      (vc-state-base                             (:foreground darktooth-bright-green))
      ...
      (vterm-color-white                         (:inherit 'term-color-white :background darktooth-foreground-0))
      ...
      (whitespace-trailing                       (:foreground darktooth-neutral-red :background darktooth-neutral-red))
      (window-divider                            (:foreground darktooth-background-0))
