...
(defmacro darktooth-deftheme (name description palette &rest body)
  ...
  `(autothemer-deftheme ,name ,description ,palette
     ((Man-overstrike                            (:foreground darktooth-sienna))
      ...
      (tab-bar-tab                               (:foreground darktooth-foreground-0 :background darktooth-background-0 :box (:line-width 5 :color darktooth-background-0 :style 'flat-button)))
      (tab-bar-tab-inactive                      (:foreground darktooth-foreground-4 :background darktooth-background-0 :box (:line-width 5 :color darktooth-background-0 :style 'flat-button)))
